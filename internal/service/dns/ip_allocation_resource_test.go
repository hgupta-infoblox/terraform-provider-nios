...
func TestAccIPAllocationResource_Snmp3Credential(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Case2: Update only authentication password and Read
			{
			...
			// Case3: Update only privacy password and Read
			{
			...
			// Case4: Create without secrets, add snmp3_credential and Read
			{
			...
			// Case5: Create with secrets, delete snmp3_credential and Read
			{
			...
			// Case6: Create with secrets, update non-secret field and Read
			{
